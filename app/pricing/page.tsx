          ...
          <>
            ...
            <div className="mt-16">
              ...
              <div className="space-y-4 max-w-3xl mx-auto">
                <FAQ question="What counts as one patient file?" answer="One patient file covers 15 analysis slots. Each daily round note, learning spark session, and discharge summary uses one slot. Editing the initial patient history and re-running analysis also uses a slot — this prevents a single file being recycled for different patients. Once 15 slots are used, continuing analysis for that patient draws one additional file from your monthly allowance." />
