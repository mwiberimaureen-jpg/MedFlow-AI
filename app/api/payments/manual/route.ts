...
const PLAN_CONFIG = {
  basic: { amount: 1000, label: 'Basic (30 analyses/month)' },
  pro:   { amount: 2000, label: 'Pro (75 analyses/month)' },
} as const
        ...
        body: JSON.stringify({
          ...
          html: `
            ...
            <table style="font-family:sans-serif;font-size:14px;border-collapse:collapse">
              ...
              <tr><td style="padding:4px 12px 4px 0;color:#6b7280">Plan</td><td>${plan.label}</td></tr>
              <tr><td style="padding:4px 12px 4px 0;color:#6b7280">Amount</td><td>KES ${plan.amount.toLocaleString()}</td></tr>
